  ...
  return (
    <section className='max-container text-center'>
      ...
      <div className='py-16 '>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>I have worked with CDON for a long time, during which I have sharpen my skills in customer service to perfection. This experience has also allowed me to develop effective methods for working in a team and my skills in coding from my Internship.</p>
      </div>
